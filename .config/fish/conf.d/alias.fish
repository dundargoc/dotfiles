...
alias gbam="git branch --all --merged"
...
alias np "reset; npx npm-groovy-lint"
alias npf "reset; npx npm-groovy-lint --format"
alias npff "reset; npx npm-groovy-lint --fix"
